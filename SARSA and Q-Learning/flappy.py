...
class FlappyBird:
    def __init__(self):
        self.FPS = 1000  # change this value can get different training speed
    ...
    def main(self):
        ...
        # state and action
        self.num_statex = int((self.SCREENWIDTH + 200))
        self.num_statey = int((self.SCREENHEIGHT + 250))
        self.num_states = (self.num_statex * self.num_statey)
        self.action = 1  # 1 move, 0 not move
        self.num_actions = 2
    ...
    def next(self, a):
        ...
        # don't crash then get reward = 1 else -1000
    ...
    def lookup(self):
        ...
        for x in range(0 - x, int(self.SCREENWIDTH + 200) - x):
            for y in range(-322, 440):
